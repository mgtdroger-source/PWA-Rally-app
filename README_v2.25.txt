STC Recorder PWA v2.25 Field Test - top sticky/rally stopwatch tidy over frozen line engine

Built from v2.23 after the 10-STC proof run confirmed the Method 2 / Method P line engine.
This bake is intentionally a top sticky container and rally stopwatch tidy bake. Method 2, Method P, and v2.24 button-mode selection logic are not intentionally changed.

Package identity:
- Header: Version 2.25
- Package: STC Recorder v2.25 / cache v2-25-1
- APP_VERSION = '2.25'
- Service worker cache = stc-pwa-v2-25-1
- Manifest link = manifest.webmanifest?v=2.25
- Service worker register = service-worker.js?v=2.25
...
1. Top sticky container slimmed
   ...
   - STC Recorder v2.25 is shown in small print.
