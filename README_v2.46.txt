STC Recorder PWA v2.46 - Setup lock and start-time keypad refinement
...
- Updated app, manifest and service-worker cache versions to v2.46.
...
Changes in v2.46:
- Running guidance now replaces the Setup help line.
- The note beneath Reset App has been removed.
- Reset restores the original Setup help line.
