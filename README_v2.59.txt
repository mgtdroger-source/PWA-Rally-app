...
CURRENT v2.59 REVIEW-ENTRY POLISH
- Review/Edit STC time fields now use the same proven entry behaviour as Rally Start Time.
- Touch selects the full existing time. Six entered digits auto-format to HH:MM:SS and close the keyboard.
- The separate numeric/decimal keyboard override has been removed.
- Dismissing the keyboard without changing the value retains the original time.
