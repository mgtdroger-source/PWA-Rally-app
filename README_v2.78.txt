...
- Automatic Event End stops collection, retains the Event End display, and continues delivering the queue until Track reaches 0.
- Event End detection fallback is 200 m, matching the updated Code.gs link configuration.
