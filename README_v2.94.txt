...
v2.94 — PWA install-handover refinement
...
Package identity
STC Recorder v2.94 / cache v2-94-1
...
v2.94: After successful PWA installation, the browser handover now separates and highlights “This page/tab should now be closed.” Timing/GPS/submission logic unchanged.
