...
v2.95 — Startup location safeguard
...
Package identity
STC Recorder v2.95 / cache v2-95-1
...
v2.95 location-startup change only:
...
v2.95: After successful PWA installation, the browser handover now separates and highlights “This page/tab should now be closed.” Timing/GPS/submission logic unchanged.


v2.95: On app opening, the existing GPS watch now provides an immediate location safeguard. If no location can be obtained, Rally Recorder shows a clear Location Required modal advising the user to turn Location Services ON and allow Precise Location. A successful GPS fix clears the warning automatically. GPS crossing/timing/submission logic is unchanged.
