...
v2.96 — App-close recovery refinement
...
v2.96 — Startup location safeguard
...
Package identity
STC Recorder v2.96 / cache v2-96-1
...
v2.96 location-startup change only:
...
v2.96: After successful PWA installation, the browser handover now separates and highlights “This page/tab should now be closed.” Timing/GPS/submission logic unchanged.


v2.96: On app opening, the existing GPS watch now provides an immediate location safeguard. If no location can be obtained, Rally Recorder shows a clear Location Required modal advising the user to turn Location Services ON and allow Precise Location. A successful GPS fix clears the warning automatically. GPS crossing/timing/submission logic is unchanged.
